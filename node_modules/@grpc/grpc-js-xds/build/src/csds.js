            ...
            for (const [type, typeMap] of authorityState.resourceMap) {
                for (const [key, resourceState] of typeMap) {
                    ...
                    genericConfigList.push({
                        name: resources_1.xdsResourceNameToString({ authority, key }, typeUrl),
                        type_url: typeUrl,
...
const loadedProto = proto_loader_1.loadSync('envoy/service/status/v3/csds.proto', {
    keepCase: true,
    longs: String,
    enums: String,
    defaults: true,
...
const csdsGrpcObject = grpc_js_1.loadPackageDefinition(loadedProto);
