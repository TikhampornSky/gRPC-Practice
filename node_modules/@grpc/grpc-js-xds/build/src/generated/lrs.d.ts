...
export interface ProtoGrpcType {
    envoy: {
        ...
        service: {
            load_stats: {
                v3: {
                    LoadReportingService: SubtypeConstructor<typeof grpc.Client, _envoy_service_load_stats_v3_LoadReportingServiceClient> & {
                        service: _envoy_service_load_stats_v3_LoadReportingServiceDefinition;
                    };
