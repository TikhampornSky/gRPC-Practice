...
exports.createHttpFilter = exports.parseOverrideFilterConfig = exports.parseTopLevelFilterConfig = exports.validateOverrideFilter = exports.validateTopLevelFilter = exports.getTopLevelFilterUrl = exports.registerHttpFilter = void 0;
...
function registerHttpFilter(typeName, entry) {
    trace('Registered filter with type URL ' + typeName);
    FILTER_REGISTRY.set(typeName, entry);
}
exports.registerHttpFilter = registerHttpFilter;
...
exports.getTopLevelFilterUrl = getTopLevelFilterUrl;
function validateTopLevelFilter(httpFilter) {
...
exports.validateTopLevelFilter = validateTopLevelFilter;
function validateOverrideFilter(encodedConfig) {
    let typeUrl;
    let realConfig;
    let isOptional = false;
    if (encodedConfig.type_url === FILTER_CONFIG_URL) {
        const filterConfig = parseAnyMessage(encodedConfig);
        if (filterConfig) {
...
exports.validateOverrideFilter = validateOverrideFilter;
function parseTopLevelFilterConfig(encodedConfig) {
    let typeUrl;
    try {
        typeUrl = getTopLevelFilterUrl(encodedConfig);
    }
...
exports.parseTopLevelFilterConfig = parseTopLevelFilterConfig;
function parseOverrideFilterConfig(encodedConfig) {
    let typeUrl;
    let realConfig;
    if (encodedConfig.type_url === FILTER_CONFIG_URL) {
        const filterConfig = parseAnyMessage(encodedConfig);
...
exports.parseOverrideFilterConfig = parseOverrideFilterConfig;
function createHttpFilter(config, overrideConfig) {
...
exports.createHttpFilter = createHttpFilter;
