...
function parseHTTPFaultConfig(encodedConfig) {
    ...
    if (parsedMessage.delay !== null) {
        ...
        const percentage = fraction_1.envoyFractionToFraction(parsedMessage.delay.percentage);
    ...
    if (parsedMessage.abort !== null) {
        ...
        const percentage = fraction_1.envoyFractionToFraction(parsedMessage.abort.percentage);
...
class FaultInjectionFilterFactory {
    constructor(config, overrideConfig) {
        if ((overrideConfig === null || overrideConfig === void 0 ? void 0 : overrideConfig.typeUrl) === FAULT_INJECTION_FILTER_URL) {
...
function setup() {
    http_filter_1.registerHttpFilter(FAULT_INJECTION_FILTER_URL, {
