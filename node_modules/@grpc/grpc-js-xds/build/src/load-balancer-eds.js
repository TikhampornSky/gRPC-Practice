...
class EdsLoadBalancingConfig {
    constructor(cluster, localityPickingPolicy, endpointPickingPolicy, edsServiceName, lrsLoadReportingServerName, maxConcurrentRequests, outlierDetection) {
    ...
    static createFromJson(obj) {
        ...
        let validatedOutlierDetectionConfig = undefined;
        if (environment_1.EXPERIMENTAL_OUTLIER_DETECTION) {
            if ('outlier_detection' in obj) {
                const outlierDetectionConfig = experimental_1.validateLoadBalancingConfig(obj.outlier_detection);
...
class EdsLoadBalancer {
    constructor(channelControlHelper) {
        ...
        this.childBalancer = new ChildLoadBalancerHandler(grpc_js_1.experimental.createChildChannelControlHelper(this.channelControlHelper, {
                    ...
                    pick: (pickArgs) => {
                        ...
                        if (dropCategory === null) {
                            ...
                            if (dropCategory === true) {
                                ...
                                (_b = this.clusterDropStats) === null || _b === void 0 ? void 0 : _b.addCallDropped(dropCategory);
                            }
                            return {
    ...
    updateChild() {
        ...
        for (const [priority, localityArray] of priorityList.entries()) {
            ...
            if (environment_1.EXPERIMENTAL_OUTLIER_DETECTION) {
                outlierDetectionConfig = (_b = this.lastestConfig.getOutlierDetection()) === null || _b === void 0 ? void 0 : _b.copyWithChildPolicy([weightedTargetConfig]);
            }
            const priorityChildConfig = outlierDetectionConfig !== null && outlierDetectionConfig !== void 0 ? outlierDetectionConfig : weightedTargetConfig;
    ...
    updateAddressList(addressList, lbConfig, attributes) {
        ...
        if (lbConfig.getLrsLoadReportingServerName()) {
            this.clusterDropStats = this.xdsClient.addClusterDropStats(lbConfig.getLrsLoadReportingServerName(), lbConfig.getCluster(), (_b = lbConfig.getEdsServiceName()) !== null && _b !== void 0 ? _b : '');
        }
