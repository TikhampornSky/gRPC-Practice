...
export declare class ExactValueMatcher implements ValueMatcher {
    private targetValue;
    private ignoreCase;
    constructor(targetValue: string, ignoreCase: boolean);
    apply(value: string): boolean;
    toString(): string;
}
...
export declare class PrefixValueMatcher implements ValueMatcher {
    private prefix;
    private ignoreCase;
    constructor(prefix: string, ignoreCase: boolean);
    apply(value: string): boolean;
    toString(): string;
}
export declare class SuffixValueMatcher implements ValueMatcher {
    private suffix;
    private ignoreCase;
    constructor(suffix: string, ignoreCase: boolean);
    apply(value: string): boolean;
    toString(): string;
}
export declare class ContainsValueMatcher implements ValueMatcher {
    private contains;
    private ignoreCase;
    constructor(contains: string, ignoreCase: boolean);
    apply(value: string): boolean;
    toString(): string;
}
