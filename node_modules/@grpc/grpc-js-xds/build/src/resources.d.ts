...
export declare type EdsTypeUrl = 'type.googleapis.com/envoy.config.endpoint.v3.ClusterLoadAssignment';
export declare type CdsTypeUrl = 'type.googleapis.com/envoy.config.cluster.v3.Cluster';
export declare type LdsTypeUrl = 'type.googleapis.com/envoy.config.listener.v3.Listener';
export declare type RdsTypeUrl = 'type.googleapis.com/envoy.config.route.v3.RouteConfiguration';
export declare type AdsTypeUrl = EdsTypeUrl | CdsTypeUrl | RdsTypeUrl | LdsTypeUrl;
...
export declare type HttpConnectionManagerTypeUrl = 'type.googleapis.com/envoy.extensions.filters.network.http_connection_manager.v3.HttpConnectionManager';
export declare const CLUSTER_CONFIG_TYPE_URL = "type.googleapis.com/envoy.extensions.clusters.aggregate.v3.ClusterConfig";
export declare type ClusterConfigTypeUrl = 'type.googleapis.com/envoy.extensions.clusters.aggregate.v3.ClusterConfig';
/**
 * Map type URLs to their corresponding message types
 */
export declare type AdsOutputType<T extends AdsTypeUrl | HttpConnectionManagerTypeUrl | ClusterConfigTypeUrl> = T extends EdsTypeUrl ? ClusterLoadAssignment__Output : T extends CdsTypeUrl ? Cluster__Output : T extends RdsTypeUrl ? RouteConfiguration__Output : T extends LdsTypeUrl ? Listener__Output : T extends HttpConnectionManagerTypeUrl ? HttpConnectionManager__Output : ClusterConfig__Output;
