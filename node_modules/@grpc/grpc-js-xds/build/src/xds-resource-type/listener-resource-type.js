...
class ListenerResourceType extends xds_resource_type_1.XdsResourceType {
    ...
    validateResource(message) {
        ...
        switch (httpConnectionManager.route_specifier) {
            case 'rds':
                if (!((_c = (_b = httpConnectionManager.rds) === null || _b === void 0 ? void 0 : _b.config_source) === null || _c === void 0 ? void 0 : _c.ads) && !((_e = (_d = httpConnectionManager.rds) === null || _d === void 0 ? void 0 : _d.config_source) === null || _e === void 0 ? void 0 : _e.self)) {
                    return null;
                }
                return message;
            case 'route_config':
    ...
    decode(context, resource) {
        ...
        const message = resources_1.decodeSingleResource(resources_1.LDS_TYPE_URL, resource.value);
